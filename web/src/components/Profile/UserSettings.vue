  ...
  <div>
    <form>
      <div class="form-group">
        ...
        <div v-if="isEditable" class="formWithSupText">
          <input
            id="name"
      ...
      <!-- <hr v-if="isEditable" />
      <div v-if="isEditable" class="form-group">Сменить пароль</div>
      ...
      <div class="row justify-content-between mt-5 mx-0">
        <div class="form-group-lg-2 form-group-md-5 form-group-sm-12 form-group-12">
          <button class="btn btn-submit w-100" @click.prevent="updateUser">
            <span v-if="isEditable">Сохранить</span>
        ...
        >
          <button v-if="isEditable" class="btn btn-delete w-100" @click.prevent="isEditable = false">
            <span>Отмена</span>
          </button>
